...
sub banner() {
print color('bold red'),"  ______ ______ ______ ______              __               ";
print color('bold white'),"|      |      |      |   __ \.----.--.--.|  |_.-----.----.\n";
print color('bold red'),"|  --  |  --  |_     |   __ <|   _|  |  ||   _|  -__|   _|\n";
print color('bold red'),"|  --  |  --  |_     |   __ <|   _|  |  ||   _|  -__|   _|";
print color('bold red'),"\t\t        [";
print color('bold white'),"C0d3d By Mmarwan 007";
print color('bold red'),"]\n";
print color('reset');
};
...
sub help {
print q(
Usage:  perl bruter.pl -l list.txt -p passwords.txt 
